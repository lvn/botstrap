...
var Response = exports.Response = function Response(rtm, web, channel, message) {
  this.rtm = rtm;
  this.web = web;
...
Response.prototype.end = function end(data) {
  ...
  if (!this.sent && this.channel) {
    (this.data.length > 0) && this.rtm.sendMessage(this.data, this.channel.id);
    this.sent = true;
  }
};
...
Response.prototype.react = function react(rxn) {
  this.web.reactions.add(rxn, {
